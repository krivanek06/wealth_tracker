export enum INVESTMENT_ACCOUNT_ERROR {
	...
	NOT_ALLOWED_TO_CREATE = 'You reacted you limit of creating investment accounts, no additional investment account is allowed',
}
...
export enum INVESTMENT_ACCOUNT_HOLDING_ERROR {
	...
	UNSUPPORTED_DATE_RANGE = 'Provided input date is too old or in the future',
